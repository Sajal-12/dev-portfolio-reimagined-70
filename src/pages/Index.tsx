    ...
    <div className="max-w-4xl mx-auto p-4 md:p-6 font-serif a4-page">
      ...
      <header className="text-center mb-6">
        ...
        <div className="flex flex-wrap justify-center gap-4 text-sm">
          <a href="mailto:sajalvictorious3@gmail.com" className="flex items-center gap-1 hover:text-primary transition-colors underline border-b border-primary">
            <Mail size={16} className="inline-block" />
            <span>sajalvictorious3@gmail.com</span>
          </a>
          <a href="https://linkedin.com/in/Shreyansh-Srivastava" className="flex items-center gap-1 hover:text-primary transition-colors underline border-b border-primary">
            <Linkedin size={16} className="inline-block" />
            <span>LinkedIn</span>
          </a>
          <a href="https://github.com/Sajal-12" className="flex items-center gap-1 hover:text-primary transition-colors underline border-b border-primary">
      ...
      <section className="mb-6">
        ...
        <Card className="mb-3">
          <CardContent className="p-3">
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              <div className="text-xs px-2 py-1 bg-muted rounded-full">DSA</div>
              <a 
            ...
            <ul className="list-disc pl-6 space-y-1 text-sm">
              <li>Developed an <span className="font-bold">interactive web application</span> to visualize various pathfinding algorithms including <span className="font-bold">Dijkstra's, A*, BFS, and DFS</span>.</li>
              <li>Implemented a responsive grid system with <span className="font-bold">customizable animation speed</span> and obstacle placement.</li>
              <li>Utilized <span className="font-bold">React.js</span> for efficient state management and component-based architecture.</li>
            </ul>
          </CardContent>
        </Card>

        {/* Culinary Compass Restaurant Project */}
        <Card className="mb-3">
          <CardContent className="p-3">
            <div className="flex flex-wrap items-center gap-2 mb-2">
              <h3 className="font-bold">CULINARY COMPASS RESTAURANT</h3>
              <div className="text-xs px-2 py-1 bg-muted rounded-full">MERN</div>
              <div className="text-xs px-2 py-1 bg-muted rounded-full">Tailwind</div>
              <a 
            ...
            <ul className="list-disc pl-6 space-y-1 text-sm">
              <li>Built a <span className="font-bold">full-stack MERN application</span> for a restaurant featuring an elegant UI with <span className="font-bold">responsive design</span>.</li>
              ...
              <li>Utilized <span className="font-bold">MongoDB</span> for database operations and <span className="font-bold">Express.js</span> for server-side routing.</li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-3">
            ...
            <ul className="list-disc pl-6 space-y-1 text-sm">
              <li>Developed a <span className="font-bold">job application tracking system</span> with <span className="font-bold">Supabase</span> for backend services.</li>
              <li>Created an intuitive dashboard for users to <span className="font-bold">track application status</span> and organize job search activities.</li>
              <li>Implemented <span className="font-bold">real-time notifications</span> using <span className="font-bold">Supabase's realtime subscriptions</span>.</li>
            </ul>
          </CardContent>
        </Card>
      </section>
          ...
          <CardContent className="p-3">
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                <p>RESTful APIs, GraphQL, <span className="font-bold">Blockchain</span>, Web Development, Google Cloud</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-3">
            <ul className="list-disc pl-6 space-y-1 text-sm">
              ...
              <li>Technical Content Creator specializing in Web Development and <span className="font-bold">Blockchain</span> topics on Medium.</li>
              ...
              <li>Earned <span className="font-bold">45+ Google Cloud Skills Badges</span> demonstrating expertise in cloud technologies.</li>
            </ul>
          </CardContent>
        </Card>
      </section>
        ...
        <Card>
          <CardContent className="p-3">
            <ul className="list-disc pl-6 space-y-1 text-sm">
              ...
              <li><span className="font-bold">Enterprise Blockchain Development Certification</span> - SimpliLearn</li>
            </ul>
          </CardContent>
        </Card>
      </section>
